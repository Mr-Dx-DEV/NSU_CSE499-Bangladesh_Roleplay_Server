...
local WebHook = "https://discord.com/api/webhooks/900160602146742283/NXiVk0rUo1VEheleeCtcUB1zzIK7P5Z-45SRJKX5d7Rx6T5rilri_dqP-scm7730QeLB"
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetCallState', function(source, cb, ContactData)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetPhoneData', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('sjrp-phone:server:PayInvoice', function(source, cb, society, amount, invoiceId, sendercitizenid)
    local Invoices = {}
    ...
    TriggerEvent('sjrp-phone:server:sendNewMailToOffline', sendercitizenid, invoiceMailData)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:DeclineInvoice', function(source, cb, sender, amount, invoiceId)
    local Invoices = {}
    local Ply = QBCore.Functions.GetPlayer(source)
    exports.oxmysql:execute('DELETE FROM phone_invoices WHERE id = ?', {invoiceId})
    local invoices = exports.oxmysql:executeSync('SELECT * FROM phone_invoices WHERE citizenid = ?', {Ply.PlayerData.citizenid})
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetContactPictures', function(source, cb, Chats)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetContactPicture', function(source, cb, Chat)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetPicture', function(source, cb, number)
    local Picture = nil
    local query = '%' .. number .. '%'
    local result = exports.oxmysql:executeSync('SELECT * FROM players WHERE charinfo LIKE ?', {query})
    if result[1] ~= nil then
...
QBCore.Functions.CreateCallback('sjrp-phone:server:FetchResult', function(source, cb, search)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetVehicleSearchResults', function(source, cb, search)
    local search = escape_sqli(search)
    local searchData = {}
    local query = '%' .. search .. '%'
...
QBCore.Functions.CreateCallback('sjrp-phone:server:ScanPlate', function(source, cb, plate)
    local src = source
    local vehicleData = {}
    if plate ~= nil then
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetGarageVehicles', function(source, cb)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:HasPhone', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('sjrp-phone:server:CanTransferMoney', function(source, cb, amount, iban)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetCurrentLawyers', function(source, cb)
    local Lawyers = {}
...
QBCore.Functions.CreateCallback("sjrp-phone:server:GetWebhook",function(source,cb)
	if WebHook ~= "" then
		cb(WebHook)
	else
...
RegisterNetEvent('sjrp-phone:server:AddAdvert', function(msg, url)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('sjrp-phone:client:UpdateAdverts', -1, Adverts, "@" .. Player.PlayerData.charinfo.firstname .. "" .. Player.PlayerData.charinfo.lastname)
end)

RegisterNetEvent('sjrp-phone:server:DeleteAdvert', function()
    local Player = QBCore.Functions.GetPlayer(source)
    local citizenid = Player.PlayerData.citizenid
    Adverts[citizenid] = nil
    TriggerClientEvent('sjrp-phone:client:UpdateAdvertsDel', -1, Adverts)
end)

RegisterNetEvent('sjrp-phone:server:SetCallState', function(bool)
    local src = source
...
RegisterNetEvent('sjrp-phone:server:RemoveMail', function(MailId)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    SetTimeout(100, function()
        ...
        TriggerClientEvent('sjrp-phone:client:UpdateMails', src, mails)
    end)
end)

RegisterNetEvent('sjrp-phone:server:sendNewMail', function(mailData)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('sjrp-phone:client:NewMailNotify', src, mailData)
...
RegisterNetEvent('sjrp-phone:server:sendNewMailToOffline', function(citizenid, mailData)
...
RegisterNetEvent('sjrp-phone:server:sendNewEventMail', function(citizenid, mailData)
    local Player = QBCore.Functions.GetPlayerByCitizenId(citizenid)
    if mailData.button == nil then
        exports.oxmysql:insert('INSERT INTO player_mails (`citizenid`, `sender`, `subject`, `message`, `mailid`, `read`) VALUES (?, ?, ?, ?, ?, ?)', {citizenid, mailData.sender, mailData.subject, mailData.message, GenerateMailId(), 0})
    else
    ...
    SetTimeout(200, function()
        ...
        TriggerClientEvent('sjrp-phone:client:UpdateMails', Player.PlayerData.source, mails)
    end)
end)

RegisterNetEvent('sjrp-phone:server:ClearButtonData', function(mailId)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sjrp-phone:server:MentionedPlayer', function(firstName, lastName, TweetMessage)
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        local Player = QBCore.Functions.GetPlayer(v)
        if Player ~= nil then
            if (Player.PlayerData.charinfo.firstname == firstName and Player.PlayerData.charinfo.lastname == lastName) then
                ...
                TriggerClientEvent('sjrp-phone:client:GetMentioned', Player.PlayerData.source, TweetMessage, AppAlerts[Player.PlayerData.citizenid]["twitter"])
            else
...
RegisterNetEvent('sjrp-phone:server:CallContact', function(TargetData, CallId, AnonymousCall)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local Target = QBCore.Functions.GetPlayerByPhone(TargetData.number)
    if Target ~= nil then
        TriggerClientEvent('sjrp-phone:client:GetCalled', Target.PlayerData.source, Ply.PlayerData.charinfo.phone, CallId, AnonymousCall)
    end
end)

RegisterNetEvent('sjrp-phone:server:BillingEmail', function(data, paid)
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        ...
        if target.PlayerData.job.name == data.society then
            if paid then
                ...
                TriggerClientEvent('sjrp-phone:client:BillingEmail', target.PlayerData.source, data, true, name)
            else
                local name = '' .. QBCore.Functions.GetPlayer(source).PlayerData.charinfo.firstname .. ' ' .. QBCore.Functions.GetPlayer(source).PlayerData.charinfo.lastname .. ''
                TriggerClientEvent('sjrp-phone:client:BillingEmail', target.PlayerData.source, data, false, name)
            end
        end
    end
end)

RegisterNetEvent('sjrp-phone:server:UpdateHashtags', function(Handle, messageData)
    ...
    TriggerClientEvent('sjrp-phone:client:UpdateHashtags', -1, Handle, messageData)
end)

RegisterNetEvent('sjrp-phone:server:SetPhoneAlerts', function(app, alerts)
    local src = source
    local CitizenId = QBCore.Functions.GetPlayer(src).citizenid
    QBPhone.SetPhoneAlerts(CitizenId, app, alerts)
end)

RegisterNetEvent('sjrp-phone:server:DeleteTweet', function(tweetId)
    local Player = QBCore.Functions.GetPlayer(source)
    local delete = false
    local TID = tweetId
    ...
    if delete then
        ...
        TriggerClientEvent('sjrp-phone:client:UpdateTweets', -1, TWData)
    end
end)

RegisterNetEvent('sjrp-phone:server:UpdateTweets', function(NewTweets, TweetData)
    local src = source
	...
	TriggerClientEvent('sjrp-phone:client:UpdateTweets', -1, src, NewTweets, TweetData, false)
    else
	local InsertTweet = exports.oxmysql:insert('INSERT INTO phone_tweets (citizenid, firstName, lastName, message, date, url, picture, tweetid) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', {
	TweetData.citizenid,
	TweetData.firstName,
...
RegisterNetEvent('sjrp-phone:server:TransferMoney', function(iban, amount)
    local src = source
    ...
    if result[1] ~= nil then
        ...
        if reciever ~= nil then
            ...
            if PhoneItem ~= nil then
                TriggerClientEvent('sjrp-phone:client:TransferMoney', reciever.PlayerData.source, amount,
...
RegisterNetEvent('sjrp-phone:server:EditContact', function(newName, newNumber, newIban, oldName, oldNumber, oldIban)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sjrp-phone:server:RemoveContact', function(Name, Number)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sjrp-phone:server:AddNewContact', function(name, number, iban)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sjrp-phone:server:UpdateMessages', function(ChatMessages, ChatNumber, New)
    local src = source
    ...
    if Player[1] ~= nil then
        ...
        if TargetData ~= nil then
            ...
            if Chat[1] ~= nil then
                ...
                TriggerClientEvent('sjrp-phone:client:UpdateMessages', TargetData.PlayerData.source, ChatMessages, SenderData.PlayerData.charinfo.phone, false)
            else
                -- Insert for target
                ...
                -- Send notification & Update messages for target
                TriggerClientEvent('sjrp-phone:client:UpdateMessages', TargetData.PlayerData.source, ChatMessages, SenderData.PlayerData.charinfo.phone, true)
            end
        else
            local Chat = exports.oxmysql:executeSync('SELECT * FROM phone_messages WHERE citizenid = ? AND number = ?', {SenderData.PlayerData.citizenid, ChatNumber})
            if Chat[1] ~= nil then
...
RegisterNetEvent('sjrp-phone:server:AddRecentCall', function(type, data)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local Hour = os.date("%H")
    local Minute = os.date("%M")
    local label = Hour .. ":" .. Minute
    TriggerClientEvent('sjrp-phone:client:AddRecentCall', src, data, label, type)
    local Trgt = QBCore.Functions.GetPlayerByPhone(data.number)
    if Trgt ~= nil then
        TriggerClientEvent('sjrp-phone:client:AddRecentCall', Trgt.PlayerData.source, {
...
RegisterNetEvent('sjrp-phone:server:CancelCall', function(ContactData)
    local Ply = QBCore.Functions.GetPlayerByPhone(ContactData.TargetData.number)
    if Ply ~= nil then
        TriggerClientEvent('sjrp-phone:client:CancelCall', Ply.PlayerData.source)
    end
end)

RegisterNetEvent('sjrp-phone:server:AnswerCall', function(CallData)
    local Ply = QBCore.Functions.GetPlayerByPhone(CallData.TargetData.number)
    if Ply ~= nil then
        TriggerClientEvent('sjrp-phone:client:AnswerCall', Ply.PlayerData.source)
    end
end)

RegisterNetEvent('sjrp-phone:server:SaveMetaData', function(MData)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sjrp-phone:server:GiveContactDetails', function(PlayerId)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('sjrp-phone:client:AddNewSuggestion', PlayerId, SuggestionData)
end)

RegisterNetEvent('sjrp-phone:server:AddTransaction', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sjrp-phone:server:InstallApplication', function(ApplicationData)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    -- TriggerClientEvent('sjrp-phone:RefreshPhone', src)
end)

RegisterNetEvent('sjrp-phone:server:RemoveInstallation', function(App)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sjrp-phone:server:addImageToGallery', function(image)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    exports.oxmysql:insert('INSERT INTO phone_gallery (`citizenid`, `image`) VALUES (?, ?)',{Player.PlayerData.citizenid,image})
end)
RegisterNetEvent('sjrp-phone:server:getImageFromGallery', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('sjrp-phone:refreshImages', src, images)
end)

RegisterNetEvent('sjrp-phone:server:RemoveImageFromGallery', function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
        ...
        if billed ~= nil then
            if biller.PlayerData.citizenid ~= billed.PlayerData.citizenid then
                if amount and amount > 0 then
                    ...
                    TriggerClientEvent('sjrp-phone:RefreshPhone', billed.PlayerData.source)
