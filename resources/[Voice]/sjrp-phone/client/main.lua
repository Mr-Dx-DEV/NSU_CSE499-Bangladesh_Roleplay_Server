...
local function LoadPhone()
    Wait(100)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetPhoneData', function(pData)
...
local function OpenPhone()
    QBCore.Functions.TriggerCallback('sjrp-phone:server:HasPhone', function(HasPhone)
        if HasPhone then
            PhoneData.PlayerData = QBCore.Functions.GetPlayerData()
            ...
            QBCore.Functions.TriggerCallback('sjrp-phone:server:GetGarageVehicles', function(vehicles)
...
local function CallContact(CallData, AnonymousCall)
    ...
    TriggerServerEvent('sjrp-phone:server:CallContact', PhoneData.CallData.TargetData, PhoneData.CallData.CallId, AnonymousCall)
    TriggerServerEvent('sjrp-phone:server:SetCallState', true)
...
local function CancelCall()
    TriggerServerEvent('sjrp-phone:server:CancelCall', PhoneData.CallData)
    if PhoneData.CallData.CallType == "ongoing" then
        exports['sjrp-voice']:removePlayerFromCall(PhoneData.CallData.CallId)
    end
    ...
    TriggerServerEvent('sjrp-phone:server:SetCallState', false)
...
local function AnswerCall()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        ...
        TriggerServerEvent('sjrp-phone:server:AnswerCall', PhoneData.CallData)
        exports['sjrp-voice']:addPlayerToCall(PhoneData.CallData.CallId)
    else
        PhoneData.CallData.InCall = false
        PhoneData.CallData.CallType = nil
        PhoneData.CallData.AnsweredCall = false
...
RegisterNUICallback('ClearRecentAlerts', function(data, cb)
    TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', "phone", 0)
...
RegisterNUICallback('SetBackground', function(data)
    ...
    TriggerServerEvent('sjrp-phone:server:SaveMetaData', PhoneData.MetaData)
end)
...
RegisterNUICallback('RemoveMail', function(data, cb)
    ...
    TriggerServerEvent('sjrp-phone:server:RemoveMail', MailId)
    cb('ok')
end)
...
RegisterNUICallback('AcceptMailButton', function(data)
    ...
    TriggerServerEvent('sjrp-phone:server:ClearButtonData', data.mailId)
end)
...
RegisterNUICallback('AddNewContact', function(data, cb)
    ...
    TriggerServerEvent('sjrp-phone:server:AddNewContact', data.ContactName, data.ContactNumber, data.ContactIban)
end)
...
RegisterNUICallback('GetProfilePicture', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetPicture', function(picture)
        cb(picture)
    end, number)
end)
...
RegisterNUICallback('PostAdvert', function(data)
    TriggerServerEvent('sjrp-phone:server:AddAdvert', data.message, data.url)
end)

RegisterNUICallback("DeleteAdvert", function()
    TriggerServerEvent("sjrp-phone:server:DeleteAdvert")
end)
...
RegisterNUICallback('ClearAlerts', function(data, cb)
    ...
    if PhoneData.Chats[ChatKey].Unread ~= nil then
        ...
        TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', "whatsapp", newAlerts)
...
RegisterNUICallback('PayInvoice', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('sjrp-phone:server:PayInvoice', function(CanPay, Invoices)
        if CanPay then PhoneData.Invoices = Invoices end
        cb(CanPay)
    end, society, amount, invoiceId, senderCitizenId)
    TriggerServerEvent('sjrp-phone:server:BillingEmail', data, true)
end)
...
RegisterNUICallback('DeclineInvoice', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('sjrp-phone:server:DeclineInvoice', function(CanPay, Invoices)
        PhoneData.Invoices = Invoices
        cb('ok')
    end, society, amount, invoiceId)
    TriggerServerEvent('sjrp-phone:server:BillingEmail', data, false)
end)
...
RegisterNUICallback('EditContact', function(data, cb)
    ...
    Wait(100)
    cb(PhoneData.Contacts)
    TriggerServerEvent('sjrp-phone:server:EditContact', NewName, NewNumber, NewIban, OldName, OldNumber, OldIban)
end)
...
RegisterNUICallback('PostNewTweet', function(data, cb)
    ...
    for i = 2, #Hashtag, 1 do
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            TriggerServerEvent('sjrp-phone:server:UpdateHashtags', Handle, TweetMessage)
        end
    end
        ...
        if Handle ~= nil or Handle ~= "" then
            ...
            if (Firstname ~= nil and Firstname ~= "") and (Lastname ~= nil and Lastname ~= "") then
                if Firstname ~= PhoneData.PlayerData.charinfo.firstname and Lastname ~= PhoneData.PlayerData.charinfo.lastname then
                    TriggerServerEvent('sjrp-phone:server:MentionedPlayer', Firstname, Lastname, TweetMessage)
                end
            end
        end
    end
    ...
    TriggerServerEvent('sjrp-phone:server:UpdateTweets', PhoneData.Tweets, TweetMessage)
end)

RegisterNUICallback('DeleteTweet',function(data)
    TriggerServerEvent('sjrp-phone:server:DeleteTweet', data.id)
end)
...
RegisterNUICallback('FetchSearchResults', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:FetchResult', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('InstallApplication', function(data, cb)
    ...
    if NewSlot <= Config.MaxSlots then
        TriggerServerEvent('sjrp-phone:server:InstallApplication', {
            app = data.app,
        })
        cb({
            app = data.app,
...
RegisterNUICallback('RemoveApplication', function(data, cb)
    TriggerServerEvent('sjrp-phone:server:RemoveInstallation', data.app)
end)
...
RegisterNUICallback('GetTruckerData', function(data, cb)
    ...
    local TierData = exports['sjrp-trucker']:GetTier(TruckerMeta)
    cb(TierData)
end)
...
RegisterNUICallback('DeleteImage', function(image,cb)
    TriggerServerEvent('sjrp-phone:server:RemoveImageFromGallery',image)
    Wait(400)
    TriggerServerEvent('sjrp-phone:server:getImageFromGallery')
    cb(true)
end)
...
RegisterNUICallback('DeleteContact', function(data, cb)
    ...
    TriggerServerEvent('sjrp-phone:server:RemoveContact', Name, Number)
end)
...
RegisterNUICallback('FetchVehicleResults', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetVehicleSearchResults', function(result)
        if result ~= nil then
...
RegisterNUICallback('FetchVehicleScan', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('sjrp-phone:server:ScanPlate', function(result)
        QBCore.Functions.TriggerCallback('police:IsPlateFlagged', function(flagged)
...
RegisterNUICallback('IsInRace', function(data, cb)
    local InRace = exports['sjrp-lapraces']:IsInRace()
    cb(InRace)
end)
...
RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
            ...
            IsBusy = exports['sjrp-lapraces']:IsInEditor(),
...
RegisterNUICallback('IsBusyCheck', function(data, cb)
    if data.check == "editor" then
        cb(exports['sjrp-lapraces']:IsInEditor())
    else
        cb(exports['sjrp-lapraces']:IsInRace())
    end
end)
...
RegisterNUICallback('GetPlayerHouses', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetPlayerHouses', function(Houses)
        cb(Houses)
    end)
end)

RegisterNUICallback('GetPlayerKeys', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetHouseKeys', function(Keys)
        cb(Keys)
    end)
end)
...
RegisterNUICallback('TransferCid', function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('sjrp-phone:server:TransferCid', function(CanTransfer)
        cb(CanTransfer)
    end, TransferedCid, data.HouseData)
end)

RegisterNUICallback('FetchPlayerHouses', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:MeosGetPlayerHouses', function(result)
        cb(result)
    end, data.input)
end)
...
RegisterNUICallback('GetCurrentLawyers', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetCurrentLawyers', function(lawyers)
        cb(lawyers)
    end)
end)
...
RegisterNUICallback('ClearMentions', function()
    ...
    TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', "twitter", 0)
    SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
end)
...
RegisterNUICallback('ClearGeneralAlerts', function(data)
    SetTimeout(400, function()
        ...
        TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', data.app, 0)
        SendNUIMessage({ action = "RefreshAppAlerts", AppData = Config.PhoneApplications })
    end)
end)
...
RegisterNUICallback('TransferMoney', function(data, cb)
    ...
    if tonumber(PhoneData.PlayerData.money.bank) >= data.amount then
        ...
        TriggerServerEvent('sjrp-phone:server:TransferMoney', data.iban, data.amount)
        local cbdata = {
            CanTransfer = true,
...
RegisterNUICallback('CanTransferMoney', function(data, cb)
    ...
    if (PlayerData.money.bank - amount) >= 0 then
        QBCore.Functions.TriggerCallback('sjrp-phone:server:CanTransferMoney', function(Transferd)
            if Transferd then
...
RegisterNUICallback('GetWhatsappChats', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetContactPictures', function(Chats)
        cb(Chats)
    end, PhoneData.Chats)
end)

RegisterNUICallback('CallContact', function(data, cb)
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetCallState', function(CanCall, IsOnline, contactData)
        local status = {
            CanCall = CanCall,
            IsOnline = IsOnline,
...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    if PhoneData.Chats[NumberKey] ~= nil then
        ...
        if PhoneData.Chats[NumberKey].messages[ChatKey] ~= nil then
            ...
            TriggerServerEvent('sjrp-phone:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, false)
            ...
            TriggerServerEvent('sjrp-phone:server:UpdateMessages', PhoneData.Chats[NumberKey].messages, ChatNumber, true)
            NumberKey = GetKeyByNumber(ChatNumber)
            ReorganizeChats(NumberKey)
        end
    else
    ...
    QBCore.Functions.TriggerCallback('sjrp-phone:server:GetContactPicture', function(Chat)
        SendNUIMessage({
            action = "UpdateChat",
            chatData = Chat,
...
RegisterNUICallback("TakePhoto", function(data,cb)
    ...
    while takePhoto do
      ...
      elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
         QBCore.Functions.TriggerCallback("sjrp-phone:server:GetWebhook",function(hook)
            if hook then
                exports['Screenshot']:requestScreenshotUpload(tostring(hook), "files[]", function(data)
                    local image = json.decode(data)
                    DestroyMobilePhone()
                    CellCamActivate(false, false)
                    TriggerServerEvent('sjrp-phone:server:addImageToGallery', image.attachments[1].proxy_url)
                    Wait(400)
                    TriggerServerEvent('sjrp-phone:server:getImageFromGallery')
...
RegisterNetEvent('sjrp-phone:client:TransferMoney', function(amount, newmoney)
...
-- RegisterNetEvent('sjrp-phone:client:UpdateTweetsDel', function(source, Tweets)
...
RegisterNetEvent('sjrp-phone:client:UpdateTweets', function(src, Tweets, NewTweetData, delete)
    PhoneData.Tweets = Tweets
    local MyPlayerId = PhoneData.PlayerData.source
...
RegisterNetEvent('sjrp-phone:client:RaceNotify', function(message)
    SendNUIMessage({
        action = "PhoneNotification",
        PhoneNotify = {
            title = "Racing",
...
RegisterNetEvent('sjrp-phone:client:AddRecentCall', function(data, time, type)
    ...
    TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', "phone")
...
RegisterNetEvent("sjrp-phone-new:client:BankNotify", function(text)
    SendNUIMessage({
        action = "PhoneNotification",
        NotifyData = {
            title = "Bank",
...
RegisterNetEvent('sjrp-phone:client:NewMailNotify', function(MailData)
    SendNUIMessage({
        action = "PhoneNotification",
        PhoneNotify = {
            title = "Mail",
    ...
    TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', "mail")
end)

RegisterNetEvent('sjrp-phone:client:UpdateMails', function(NewMails)
    SendNUIMessage({
        action = "UpdateMails",
        Mails = NewMails
    })
...
RegisterNetEvent('sjrp-phone:client:UpdateAdvertsDel', function(Adverts)
...
RegisterNetEvent('sjrp-phone:client:UpdateAdverts', function(Adverts, LastAd)
    PhoneData.Adverts = Adverts
    SendNUIMessage({
        action = "PhoneNotification",
        PhoneNotify = {
...
RegisterNetEvent('sjrp-phone:client:BillingEmail', function(data, paid, name)
    if paid then
...
RegisterNetEvent('sjrp-phone:client:CancelCall', function()
    if PhoneData.CallData.CallType == "ongoing" then
        SendNUIMessage({
...
RegisterNetEvent('sjrp-phone:client:GetCalled', function(CallerNumber, CallId, AnonymousCall)
    local RepeatCount = 0
    local CallData = {
        number = CallerNumber,
        ...
        if not PhoneData.CallData.AnsweredCall then
            if RepeatCount + 1 ~= Config.CallRepeats + 1 then
                if PhoneData.CallData.InCall then
                    ...
                    TriggerServerEvent('sjrp-phone:server:AddRecentCall', "missed", CallData)
                    break
                end
                Wait(Config.RepeatTimeout)
            else
...
RegisterNetEvent('sjrp-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
    ...
    if New then
	    ...
	    SendNUIMessage({
            ...
            TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', "whatsapp")
        end
    else
...
RegisterNetEvent('sjrp-phone:client:RemoveBankMoney', function(amount)
    if amount > 0 then
        SendNUIMessage({
            action = "PhoneNotification",
            PhoneNotify = {
...
RegisterNetEvent('sjrp-phone:RefreshPhone', function()
    LoadPhone()
    SetTimeout(250, function()
        SendNUIMessage({
...
RegisterNetEvent('sjrp-phone:client:AddTransaction', function(SenderData, TransactionData, Message, Title)
    local Data = {
    ...
    TriggerServerEvent('sjrp-phone:server:AddTransaction', Data)
end)

RegisterNetEvent('sjrp-phone:client:AddNewSuggestion', function(SuggestionData)
    ...
    Config.PhoneApplications["phone"].Alerts = Config.PhoneApplications["phone"].Alerts + 1
    TriggerServerEvent('sjrp-phone:server:SetPhoneAlerts', "phone", Config.PhoneApplications["phone"].Alerts)
end)

RegisterNetEvent('sjrp-phone:client:UpdateHashtags', function(Handle, msgData)
...
RegisterNetEvent('sjrp-phone:client:AnswerCall', function()
    if (PhoneData.CallData.CallType == "incoming" or PhoneData.CallData.CallType == "outgoing") and PhoneData.CallData.InCall and not PhoneData.CallData.AnsweredCall then
        PhoneData.CallData.CallType = "ongoing"
        PhoneData.CallData.AnsweredCall = true
        PhoneData.CallData.CallTime = 0
...
RegisterNetEvent('sjrp-phone:client:addPoliceAlert', function(alertData)
    PlayerJob = QBCore.Functions.GetPlayerData().job
...
RegisterNetEvent('sjrp-phone:client:addambulanceAlert', function(alertData)
    PlayerJob = QBCore.Functions.GetPlayerData().job
...
RegisterNetEvent('sjrp-phone:client:GiveContactDetails', function()
    local player, distance = GetClosestPlayer()
    if player ~= -1 and distance < 2.5 then
        local PlayerId = GetPlayerServerId(player)
        TriggerServerEvent('sjrp-phone:server:GiveContactDetails', PlayerId)
    else
        QBCore.Functions.Notify("No one nearby!", "error")
    end
end)

RegisterNetEvent('sjrp-phone:client:UpdateLapraces', function()
    SendNUIMessage({
        action = "UpdateRacingApp",
    })
end)

RegisterNetEvent('sjrp-phone:client:GetMentioned', function(TweetMessage, AppAlerts)
...
RegisterNetEvent('sjrp-phone:refreshImages', function(images)
    PhoneData.Images = images
end)

RegisterNetEvent("sjrp-phone-new:client:CustomPhoneNotification", function(title, text, icon, color, timeout) -- Send a PhoneNotification to the phone from anywhere
    SendNUIMessage({
        action = "PhoneNotification",
        NotifyData = {
            title = title,
