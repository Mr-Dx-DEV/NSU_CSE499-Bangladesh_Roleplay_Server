...
$(document).on('click', '.twitter-header-tab', function(e){
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('https://sjrp-phone/ClearMentions');
        }
...
$(document).on('click','#twt-delete-click',function(e){
    ...
    $.post('https://sjrp-phone/DeleteTweet', JSON.stringify({id: source}))
})
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        $.post('https://sjrp-phone/PostNewTweet', JSON.stringify({
...
$(document).on('click', '.hashtag-tag-text', function(e){
    ...
    if (!HashtagOpen) {
        ...
        $.post('https://sjrp-phone/GetHashtagMessages', JSON.stringify({hashtag: Hashtag}), function(HashtagData){
