...
local function connecttoradio(channel)
    ...
    if onRadio then
        exports["sjrp-voice"]:setRadioChannel(0)
    else
        onRadio = true
        exports["sjrp-voice"]:setVoiceProperty("radioEnabled", true)
    end
    exports["sjrp-voice"]:setRadioChannel(channel)
...
local function leaveradio()
    ...
    onRadio = false
    exports["sjrp-voice"]:setRadioChannel(0)
    exports["sjrp-voice"]:setVoiceProperty("radioEnabled", false)
...
RegisterNetEvent('sjrp-radio:use', function()
    toggleRadio(not radioMenu)
end)

RegisterNetEvent('sjrp-radio:onRadioDrop', function()
...
RegisterNUICallback("volumeUp", function()
	if RadioVolume <= 95 then
		...
		exports["sjrp-voice"]:setRadioVolume(RadioVolume)
	else
...
RegisterNUICallback("increaseradiochannel", function(data, cb)
    ...
    exports["sjrp-voice"]:setRadioChannel(newChannel)
...
CreateThread(function()
    while true do
        ...
        if LocalPlayer.state.isLoggedIn and onRadio then
            QBCore.Functions.TriggerCallback('sjrp-radio:server:GetItem', function(hasItem)
                if not hasItem then
                    if RadioChannel ~= 0 then
                        leaveradio()
                    end
...
RegisterNetEvent('sjrp-radio:client:JoinRadioChannel1')
AddEventHandler('sjrp-radio:client:JoinRadioChannel1', function(channel)
    local channel = 1
    exports["sjrp-voice"]:setRadioChannel(channel)
    if SplitStr(tostring(channel), ".")[2] ~= nil and SplitStr(tostring(channel), ".")[2] ~= "" then
        QBCore.Functions.Notify(Config.messages['joined_to_radio'] ..channel.. ' MHz', 'success')
...
RegisterNetEvent('sjrp-radio:client:JoinRadioChannel2')
AddEventHandler('sjrp-radio:client:JoinRadioChannel2', function(channel)
    local channel = 2
    exports["sjrp-voice"]:setRadioChannel(channel)
    if SplitStr(tostring(channel), ".")[2] ~= nil and SplitStr(tostring(channel), ".")[2] ~= "" then
        QBCore.Functions.Notify(Config.messages['joined_to_radio'] ..channel.. ' MHz', 'success')
...
RegisterNetEvent('sjrp-radio:client:JoinRadioChannel3')
AddEventHandler('sjrp-radio:client:JoinRadioChannel3', function(channel)
    local channel = 3
    exports["sjrp-voice"]:setRadioChannel(channel)
    if SplitStr(tostring(channel), ".")[2] ~= nil and SplitStr(tostring(channel), ".")[2] ~= "" then
        QBCore.Functions.Notify(Config.messages['joined_to_radio'] ..channel.. ' MHz', 'success')
...
RegisterNetEvent('sjrp-radio:client:JoinRadioChannel4')
AddEventHandler('sjrp-radio:client:JoinRadioChannel4', function(channel)
    local channel = 4
    exports["sjrp-voice"]:setRadioChannel(channel)
    if SplitStr(tostring(channel), ".")[2] ~= nil and SplitStr(tostring(channel), ".")[2] ~= "" then
        QBCore.Functions.Notify(Config.messages['joined_to_radio'] ..channel.. ' MHz', 'success')
