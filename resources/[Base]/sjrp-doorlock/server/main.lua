...
QBCore.Functions.CreateCallback('sjrp-doorlock:server:setupDoors', function(_, cb)
	cb(Config.DoorList)
end)

QBCore.Functions.CreateCallback('sjrp-doorlock:server:checkItems', function(source, cb, items, needsAll)
...
RegisterNetEvent('sjrp-doorlock:server:updateState', function(doorID, locked, src, usedLockpick, unlockAnyway, enableSounds, enableAnimation, sentSource)
	...
	TriggerClientEvent('sjrp-doorlock:client:setState', -1, playerId, doorID, locked, src or false, enableSounds, enableAnimation)
	...
	SetTimeout(Config.DoorList[doorID].autoLock, function()
		...
		TriggerClientEvent('sjrp-doorlock:client:setState', -1, playerId, doorID, true, src or false, enableSounds, enableAnimation)
	end)
end)

RegisterNetEvent('sjrp-doorlock:server:saveNewDoor', function(data, doubleDoor)
	local src = source
	...
	TriggerClientEvent('sjrp-doorlock:client:newDoorAdded', -1, configData, data.doorname)
end)

-- Commands

QBCore.Commands.Add('newdoor', Lang:t("general.newdoor_command_description"), {}, false, function(source)
	TriggerClientEvent('sjrp-doorlock:client:addNewDoor', source)
