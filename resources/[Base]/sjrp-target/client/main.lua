...
-------------------------------------------------------------------- Target ----------------------------------------------------------------------------
	...
	exports['sjrp-target']:AddTargetModel(`ig_bankman`, {
		options = {
			{ 
				event = 'nh-context:Banking', 
	...
	RegisterNetEvent('nh-context:Banking', function()
...
exports['sjrp-target']:AddTargetModel(`a_m_o_soucent_03`, {
    options = {
        { 
...
exports['sjrp-target']:AddTargetModel(`s_m_y_sheriff_01`, {
    options = {
        { 
            event = "qb-garages:client:menuGarage", 
            icon = "fas fa-car", 
...
exports['sjrp-target']:AddTargetModel(`ig_sacha`, {
    options = {
        { 
...
exports['sjrp-target']:AddTargetModel(`s_f_y_shop_low`, {
    options = {
        { 
            event = "nh-context:opendress", 
...
RegisterNetEvent('nh-context:opendress', function()
    TriggerEvent('nh-context:sendMenu', {
        {
            id = 1,
            header = "Sub Urban Dress Shop",
            txt = ""
        },
        {
            id = 2,
...
RegisterNetEvent('nh-context:opendress2', function(data)
    local id = data.id
    ...
    TriggerEvent('nh-context:sendMenu', {
		...
		{
            id = 4,
            header = "Refresh Outfit",
            txt = "Refresh Your Dress",
			params = {
                event = "Kinghunter:try",
			}
        },
    })
end)
...
exports['sjrp-target']:AddTargetModel(`s_f_m_fembarber`, {
    options = {
        { 
...
exports['sjrp-target']:AddTargetModel(`mp_m_shopkeep_01`, {
    options = {
        { 
            event = 'nh-context:shopmenu', 
            icon = "fas fa-store", 
...
RegisterNetEvent('nh-context:shopmenu', function()
	TriggerEvent('nh-context:sendMenu', {
		{
			id = 1,
	...
	exports['sjrp-target']:AddTargetModel(`a_m_y_hippy_01`, {
		options = {
			{ 
				event = 'nh-context:liquorshop', 
				icon = "fas fa-store", 
				label = "Speak with Store Employee", 
			},
		},
	...
	RegisterNetEvent('nh-context:liquorshop', function()
		TriggerEvent('nh-context:sendMenu', {
			{
				id = 1,
				header = "Liqour Shop",
...
exports['sjrp-target']:AddTargetModel(`a_f_m_business_02`, {
    options = {
        { 
            event = 'nh-context:shopmenu2', 
            icon = "fas fa-store", 
            label = "Speak with Store Employee", 
        },
    },
...
RegisterNetEvent('nh-context:shopmenu2', function()
	TriggerEvent('nh-context:sendMenu', {
		{
			id = 1,
...
exports['sjrp-target']:AddTargetModel(`a_m_y_epsilon_01`, {
    options = {
        { 
            event = 'nh-context:shopmenu3', 
            icon = "fas fa-store", 
...
RegisterNetEvent('nh-context:shopmenu3', function()
	TriggerEvent('nh-context:sendMenu', {
		{
			id = 1,
...
exports['sjrp-target']:AddTargetModel(`s_m_y_ammucity_01`, {
	options = {
        { 
            event = "qb-shops:marketshop", 
            icon = "fas fa-shopping-cart",  
...
exports['sjrp-target']:AddTargetModel(`csb_money`, {
	options = {
        { 
            event = "qb-shops:marketshop", 
            icon = "fas fa-shopping-cart",  
...
exports['sjrp-target']:AddTargetModel(`mp_f_meth_01`, {
    options = {
            {
                    event = "nh-context:pillbox",
...
-- Pillbox NH
RegisterNetEvent('nh-context:pillbox', function()
    TriggerEvent('nh-context:sendMenu', {
        {
            id = 1,
...
exports['sjrp-target']:AddTargetModel(`cs_old_man2`, {
    options = {
        { 
            event = 'nh-context:carwash', 
            icon = "fas fa-circle", 
...
RegisterNetEvent('nh-context:carwash', function()
	TriggerEvent('nh-context:sendMenu', {
		{
			id = 1,
...
exports['sjrp-target']:AddTargetModel(`csb_tomcasino`, {
    options = {
        { 
            event = 'nh-context:cityhall', 
            icon = "fas fa-circle", 
...
RegisterNetEvent('nh-context:cityhall', function()
	TriggerEvent('nh-context:sendMenu', {
		{
			id = 1,
			header = "LIFE INVADER",
...
--------------- police Garage
		...
		exports['sjrp-target']:AddTargetModel(`csb_trafficwarden`, {
			options = {
				{ 
					event = 'nh-context:policegarage', 
					icon = "fas fa-store", 
