...
rexon_dmp1 = { name = 'Rexon DMP 1', brand = 'PD', model = 'rexon_dmp1', price = 0, category = 'emergency', type = 'automobile', hash = `rexon_dmp1` },
rexon_dmp2 = { name = 'Rexon DMP 2', brand = 'PD', model = 'rexon_dmp2', price = 0, category = 'emergency', type = 'automobile', hash = `rexon_dmp2` },
rexon_dmp3 = { name = 'Rexon DMP 3', brand = 'PD', model = 'rexon_dmp3', price = 0, category = 'emergency', type = 'automobile', hash = `rexon_dmp3` },
rexon_dmp4 = { name = 'Rexon DMP 4', brand = 'PD', model = 'rexon_dmp4', price = 0, category = 'emergency', type = 'automobile', hash = `rexon_dmp4` },
rexon_dmp5 = { name = 'Rexon DMP 5', brand = 'PD', model = 'rexon_dmp5', price = 0, category = 'emergency', type = 'automobile', hash = `rexon_dmp5` },
