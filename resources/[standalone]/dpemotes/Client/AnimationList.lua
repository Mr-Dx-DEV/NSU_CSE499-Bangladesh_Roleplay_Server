...
DP.Shared = {
   ...
   ["givebj"] = {"mini@prostitutes@sexnorm_veh", "bj_loop_prostitute", "Give BJ", "getbj"},
   ["getbj"] = {"mini@prostitutes@sexnorm_veh", "bj_loop_male", "Get BJ", "givebj"},
   ["giveanal"] = {"rcmpaparazzo_2", "shag_loop_poppy", "Give Anal", "takeanal"},
   ["takeanal"] = {"rcmpaparazzo_2", "shag_loop_a", "Take Anal", "giveanal"},
