...
QBCore.Commands.Add('redeemcode', "Redeem a promo code", { {name = 'code', help = 'For example: codegen:wlq129tsd866ofp193lcc683'} }, false, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Commands.Add('createcode', 'Create a promo code (ADMIN)', {}, true, function(source)
