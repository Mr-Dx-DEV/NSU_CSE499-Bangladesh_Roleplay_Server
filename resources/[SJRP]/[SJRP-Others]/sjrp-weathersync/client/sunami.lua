...
RegisterNetEvent('strez:client:SendMailTsunamiManualOverride', function(text)
    ...
    TriggerServerEvent('sjrp-phone:server:sendNewMail', {
        sender = 'District of SJRP City',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for SJRP City, In 15 minutes! Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
    Wait(math.random(30000, 60000))
    TriggerServerEvent('qb-weathersync:server:setWeather', 'THUNDER')
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto5', function(text)
    ...
    TriggerServerEvent('sjrp-phone:server:sendNewMail', {
        sender = 'District of SJRP City',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for SJRP City, In 5 minutes! SJRP City is losing City Power, Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto1', function(text)
    ...
    TriggerServerEvent('sjrp-phone:server:sendNewMail', {
        sender = 'District of SJRP City',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for SJRP City, In 1 minutes! Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
    Wait(math.random(13000, 23000))
    TsunamiEffect()
