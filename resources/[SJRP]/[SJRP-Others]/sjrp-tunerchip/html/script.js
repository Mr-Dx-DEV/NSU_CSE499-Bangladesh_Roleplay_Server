...
$(document).on('click', '#save', function(){
    $.post('https://sjrp-tunerchip/save', JSON.stringify({
...
$(document).on('click', '#reset', function(){
    $.post('https://sjrp-tunerchip/reset');
});
...
$(document).on('click', "#save-neon", function(){
    if (RainbowNeon) {
        $.post('https://sjrp-tunerchip/saveNeon', JSON.stringify({
...
$(document).on('click', '#save-headlights', function(){
    $.post('https://sjrp-tunerchip/saveHeadlights', JSON.stringify({
        value: headlightVal,
...
$(document).on('click', '#save-stancer', function(){
    ...
    $.post('https://sjrp-tunerchip/SetStancer', JSON.stringify({
...
QBTuner.Open = function() {
    $.post('https://sjrp-tunerchip/checkItem', JSON.stringify({item: "tunerlaptop"}), function(hasItem){
        if (hasItem) {
...
QBTuner.Close = function() {
    ...
    $.post('https://sjrp-tunerchip/exit');
}