...
function showBlur() {
    $.post('https://sjrp-inventory/showBlur');
}
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://sjrp-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://sjrp-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://sjrp-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://sjrp-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://sjrp-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://sjrp-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://sjrp-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://sjrp-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://sjrp-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://sjrp-inventory/CloseInventory", JSON.stringify({}));
