...
qbCityhall.Close = function() {
    ...
    $.post('https://sjrp-cityhall/close');
...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $.post('https://sjrp-cityhall/requestLicenses', JSON.stringify({}), function(licenses){
...
$(".request-identity-button").click(function(e){
    ...
    $.post('https://sjrp-cityhall/requestId', JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    ...
    $.post('https://sjrp-cityhall/applyJob', JSON.stringify({
        job: selectedJobId
    }))
