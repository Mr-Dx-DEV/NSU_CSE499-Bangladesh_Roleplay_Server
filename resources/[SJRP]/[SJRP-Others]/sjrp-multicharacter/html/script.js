    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                refreshCharacters()
                setTimeout(function(){
                    $.post('https://sjrp-multicharacter/setupCharacters');
                    setTimeout(function(){
...
$('.disconnect-btn').click(function(e){
    e.preventDefault();
    $.post('https://sjrp-multicharacter/closeUI');
    $.post('https://sjrp-multicharacter/disconnectButton');
});
...
$(".btn-iniciar").on("click", function() {
    background.volume = 0.3;
        $(".title-screen").fadeOut(300, function() {
            ...
            $.post('https://sjrp-multicharacter/removeBlur');
        })
});
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('https://sjrp-multicharacter/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function (e) {
    ...
    console.log("FIELDS REQUIRED")
        ...
        $.post('https://sjrp-multicharacter/createNewCharacter', JSON.stringify({
            firstname: firstname,
            lastname: lastname,
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://sjrp-multicharacter/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('https://sjrp-multicharacter/selectCharacter', JSON.stringify({
