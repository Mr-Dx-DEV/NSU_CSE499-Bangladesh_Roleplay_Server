...
QBCore.Functions.CreateCallback('sjrp-phone:server:TransferCid', function(source, cb, NewCid, house)
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetPlayerHouses', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local MyHouses = {}
...
QBCore.Functions.CreateCallback('sjrp-phone:server:GetHouseKeys', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local MyKeys = {}
...
QBCore.Functions.CreateCallback('sjrp-phone:server:MeosGetPlayerHouses', function(source, cb, input)
    if input then
