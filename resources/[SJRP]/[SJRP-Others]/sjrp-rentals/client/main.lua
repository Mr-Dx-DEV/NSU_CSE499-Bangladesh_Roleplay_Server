...
SpawnNPC = function()
    CreateThread(function()
        ...
        RequestModel(GetHashKey('a_f_y_runner_01'))
        while not HasModelLoaded(GetHashKey('a_f_y_runner_01')) do
            Wait(1)
        end
        CreateNPC()   
    end)
...
CreateNPC = function()
    created_ped = CreatePed(5, GetHashKey('a_f_y_runner_01') , -1045.83, -2725.86, 19.17, 335.89, false, true)
...
AddEventHandler('qb-rental:spawncar', function(data)
    ...
    QBCore.Functions.SpawnVehicle(model, function(vehicle)
        SetEntityHeading(vehicle, 245.86)
        TaskWarpPedIntoVehicle(player, vehicle, -1)
        TriggerEvent("vehiclekeys:client:SetOwner", GetVehicleNumberPlateText(vehicle))
        SetVehicleEngineOn(vehicle, true, true)
        SpawnVehicle = true
    end, vector4(-1045.24, -2723.33, 20.09, 245.86), true)
    Wait(1000)
...
CreateThread(function()
    blip = AddBlipForCoord(-1045.83, -2725.86, 19.17)
