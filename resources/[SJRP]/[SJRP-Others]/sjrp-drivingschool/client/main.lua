...
function StartDriveTest()
    ...
    QBCore.Functions.SpawnVehicle('blista', function(vehicle)
        ...
        exports['sjrp-fuel']:SetFuel(vehicle, 100.0)
        Menu.hidden = true
			...
			if IsControlJustReleased(0, 38) then
				...
				QBCore.Functions.TriggerCallback('QBCore:HasItem', function(result1)
					if result1 then
						...
						TriggerServerEvent('qb-drivingschool:Payqb')
						StartTheoryTest()
					end
				end, 'driver_license')
		...
		if CurrentTest == 'drive' then
			...
			if IsPedInAnyVehicle(playerPed, false) then
				...
				if health < LastVehicleHealth then
					...
					QBCore.Functions.Notify("You damaged veh", "error")
					QBCore.Functions.Notify("Mistakes - "..DriveErrors.." / "..Config.MaxErrors.." ", "error")
