...
RegisterNetEvent('sjrp-menu:client:openMenu', function(data)
    openMenu(data)
end)

RegisterNetEvent('sjrp-menu:client:closeMenu', function()
    closeMenu()
end)
...
RegisterNetEvent('sjrp-menu:sendMenu', function(data, toServer)
    if not data then return end
