...
Config.SellItems = { -- Selling Prices
    ...
    ['diamond_necklace'] = 130,
    ['emerald_necklace'] = 115,
    ['ruby_necklace'] = 120,
    ['sapphire_necklace'] = 125,
...
Config.Items = {
    ...
    items = {
	[1] = { name = "weapon_flashlight", price = 70, amount = 50, info = {}, type = "item", slot = 1, }, 
	[2] = { name = "drill",	price = 500, amount = 50, info = {}, type = "item", slot = 2, }, 
	[3] = { name = "handdrill",	price = 250, amount = 50, info = {}, type = "item",	slot = 3, },
	--[4] = { name = "drillbit", price = 150, amount = 50,	info = {}, type = "item", slot = 4, }, 
	}		
}
