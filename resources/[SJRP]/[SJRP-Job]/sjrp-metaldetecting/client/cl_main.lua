...
RegisterNetEvent('qb-metaldetector:RareTradingMenu', function(data)
    exports['sjrp-menu']:openMenu({
        ...
        },
        {
            ...
            txt = "Trade 1 Burried Treasure for $100!",
            params = {
                isServer = true,
        ...
        },
        {
            id = 3,
            header = "Treasure Key",
            txt = "Trade 1 Treasure Key for $150!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:RareTrade",
                args = {
        ...
        },
        {
            id = 4,
            header = "Antique Coin",
            txt = "Trade 1 Antique Coin for $50!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:RareTrade",
                args = {
        ...
        },
        {
            id = 7,
            header = "Ancient Coin",
            txt = "Trade 1 Ancient Coin for $100!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:RareTrade",
                args = {
        ...
        },
        {
            id = 10,
            header = "Pocket Watch",
            txt = "Trade 1 Pocket watch for $15!",
            params = {
                isServer = true,
                event = "qb-metaldetector:server:RareTrade",
                args = {
