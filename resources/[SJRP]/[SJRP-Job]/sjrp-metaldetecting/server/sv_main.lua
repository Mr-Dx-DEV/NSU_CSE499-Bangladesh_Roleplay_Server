    ...
    if data.id == 2 then
        if check ~= nil then
            if check.amount >= 1 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 Burried Treasure'..' for $100.', 'success')
            else 
    ...
    elseif data.id == 3 then
        if check ~= nil then
            if check.amount >= 1 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 Treasure Key'..' for $150.', 'success')
            else 
    ...
    elseif data.id == 4 then
        if check ~= nil then
            if check.amount >= 1 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 Antique Coin'..' for $50.', 'success')
            else 
    ...
    elseif data.id == 5 then
        if check ~= nil then
            if check.amount >= 1 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 Golden Nugget'..' for $20.', 'success')
            else 
    ...
    elseif data.id == 6 then
        if check ~= nil then
            if check.amount >= 1 then
                Player.Functions.RemoveItem(item, 1)
                Player.Functions.AddMoney('cash', 30)
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 Gold Coin'..' for $30.', 'success')
            else 
    ...
    elseif data.id == 7 then
        if check ~= nil then
            if check.amount >= 1 then
                Player.Functions.RemoveItem(item, 1)
                Player.Functions.AddMoney('cash', 100)
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 Antique Coin'..' for $100.', 'success')
            else 
                TriggerClientEvent('QBCore:Notify', src, "You don't have enough Antique Coins..", 'error')
            end 
        else 
    ...
    elseif data.id == 8 then
        if check ~= nil then
            if check.amount >= 1 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 WW2 Coin'..' for $80.', 'success')
            else 
    ...
    elseif data.id == 10 then
        if check ~= nil then
            if check.amount >= 1 then
                ...
                TriggerClientEvent('QBCore:Notify', src, 'You traded 1 Pocket Watch'..' for $15.', 'success')
            else 
