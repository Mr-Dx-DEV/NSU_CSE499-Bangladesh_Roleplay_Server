...
local function OpenMenu()
    local OpenMenu = {
        ...
        
        {
            ...
            txt = "",
            params = {
                event = "sjrp-menu:client:closeMenu",
            }
        },
        
    }

    exports['sjrp-menu']:openMenu(OpenMenu)
end
...
local function PartsMenu()
    ...
    if VehicleStatus[plate] ~= nil then
        ...
        exports['sjrp-menu']:openMenu(vehicleMenu)
    end
...
local function PartMenu(data)
    ...
    exports['sjrp-menu']:openMenu(TestMenu1)
end
...
local function NoDamage()
    ...
    exports['sjrp-menu']:openMenu(NoDamage)
end
...
local function SpawnListVehicle(model)
    ...
    QBCore.Functions.SpawnVehicle(model, function(veh)
        ...
        exports['sjrp-fuel']:SetFuel(veh, 100.0)
...
------- Toggle Duty Event
RegisterNetEvent('Mech:duty')
AddEventHandler('Mech:duty', function()
    TriggerServerEvent("QBCore:ToggleDuty")

end)

------ Mechanic stash 
RegisterNetEvent('MechStash')
AddEventHandler('MechStash', function()
TriggerEvent("inventory:client:SetCurrentStash", "hayesautostash")
TriggerServerEvent("inventory:server:OpenInventory", "stash", "mechanicstash", {
    maxweight = 4000000,
    slots = 500,
})
