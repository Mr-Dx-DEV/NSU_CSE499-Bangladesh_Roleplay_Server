...
RegisterServerEvent("mdt:getOffenderDetails", function(offender)
	local usource = source
...
RegisterServerEvent("mdt:getOffenderDetailsById", function(char_id)
    local usource = source
...
RegisterServerEvent("mdt:saveOffenderChanges", function(id, changes, identifier)
	local usource = source
...
RegisterServerEvent("mdt:saveReportChanges", function(data)
...
RegisterServerEvent("mdt:deleteReport", function(id)
...
RegisterServerEvent("mdt:submitNewReport", function(data)
	local usource = source
...
RegisterServerEvent("mdt:performReportSearch", function(query)
	local usource = source
	local matches = {}
...
RegisterServerEvent("mdt:getVehicle", function(vehicle)
	local usource = source
...
RegisterServerEvent("mdt:getWarrants", function()
	local usource = source
...
RegisterServerEvent("mdt:submitNewWarrant", function(data)
	local usource = source
...
RegisterServerEvent("mdt:deleteWarrant", function(id)
	local usource = source
...
RegisterServerEvent("mdt:getReportDetailsById", function(query, _source)
...
RegisterServerEvent("mdt:newCall", function(details, caller, coords, sendNotification)
...
RegisterServerEvent("mdt:attachToCall", function(index)
	local usource = source
...
RegisterServerEvent("mdt:detachFromCall", function(index)
	local usource = source
	local charname = GetCharacterName(usource)
	local xPlayers = QBCore.Functions.GetPlayers()
	for i= 1, #xPlayers do
...
RegisterServerEvent("mdt:editCall", function(index, details)
	local usource = source
	local xPlayers = QBCore.Functions.GetPlayers()
	for i= 1, #xPlayers do
		local source = xPlayers[i]
...
RegisterServerEvent("mdt:deleteCall", function(index)
	local usource = source
	local xPlayers = QBCore.Functions.GetPlayers()
	for i= 1, #xPlayers do
		local source = xPlayers[i]
...
RegisterServerEvent("mdt:saveVehicleChanges", function(data)
