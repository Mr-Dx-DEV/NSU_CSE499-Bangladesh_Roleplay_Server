    ...
    methods: {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('https://sjrp-mdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('https://sjrp-mdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('https://sjrp-mdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('https://sjrp-mdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('https://sjrp-mdt/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('https://sjrp-mdt/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('https://sjrp-mdt/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('https://sjrp-mdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('https://sjrp-mdt/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('https://sjrp-mdt/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('https://sjrp-mdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('https://sjrp-mdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('https://sjrp-mdt/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
        ...
        AttachToCall(index) {
            $.post('https://sjrp-mdt/attachToCall', JSON.stringify({
                index: index,
        ...
        DetachFromCall(index) {
            $.post('https://sjrp-mdt/detachFromCall', JSON.stringify({
                index: index
            }));
            this.current_call = {
                source: null,
        ...
        SetCallWaypoint(index) {
            $.post('https://sjrp-mdt/setCallWaypoint', JSON.stringify({
                coords: this.calls[index].coords
            }));
            return;
        },
        ...
        SaveEditCall() {
            $.post('https://sjrp-mdt/editCall', JSON.stringify({
        ...
        DeleteCall(index) {
            $.post('https://sjrp-mdt/deleteCall', JSON.stringify({
                index: index
            }));
            return;
        },
        ...
        SaveVehicleEditChanges() {
            $.post('https://sjrp-mdt/saveVehicleChanges', JSON.stringify({
        ...
        window.addEventListener('message', function(event) {
            if (event.data.type == "enable") {
                ...
                if (mdtApp.current_call.id == mdtApp.calls[event.data.call].id) {
                    $.post('https://sjrp-mdt/deleteCallBlip')
                    mdtApp.current_call = {
                        source: null,
                        details: null,
                        id: null,
