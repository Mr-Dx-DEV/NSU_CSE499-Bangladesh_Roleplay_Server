...
local function SetRouteBack()
    ...
    exports['sjrp-target']:RemoveZone('trashcans')
...
local function SetGarbageRoute()
    ...
    exports['sjrp-target']:AddBoxZone("trashcans", vector3(CurrentLocation.pz), CurrentLocation.length, CurrentLocation.width, {
        name = "trashcans",
    ...
    QBCore.Functions.TriggerCallback('garbagejob:server:NewShift', function(shouldContinue, firstStop, totalBags)
        if shouldContinue then
            ...
            QBCore.Functions.SpawnVehicle("trash2", function(veh)
                ...
                exports['sjrp-target']:AddTargetEntity(garbageVehicle, {
                    options = {
                        {
                            type = "client",
