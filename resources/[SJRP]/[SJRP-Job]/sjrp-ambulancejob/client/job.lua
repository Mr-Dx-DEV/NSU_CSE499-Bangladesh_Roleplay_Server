...
RegisterNetEvent('hospital:client:SendEmergencyMessage', function()
    TriggerServerEvent('hospital:server:ambulanceAlert', '| 10-12A | Emergency Asap')
    TriggerEvent("hospital:client:CallAnim")
end)

RegisterNetEvent('hospital:client:CallAnim', function()
...
----- On / Off Duty command
RegisterNetEvent('Toggle:DutyAmbulance')
AddEventHandler('Toggle:DutyAmbulance', function()
    onDuty = not onDuty
    TriggerServerEvent("QBCore:ToggleDuty")
end)