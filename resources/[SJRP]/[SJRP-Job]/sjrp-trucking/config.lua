Config = {
    ...
    Jobs = {
        ...
        {title = 'Bring wood to IKEA', payment = 350, vehicles = {'daf', 'trailerlogs'}, start = {vector3(-566.59, 5353.52, 70.24), 344.31}, trailer = {vector3(-513.17, 5257.65, 80.74), 162.58}, arrive = vector3(2671.0, 3530.35, 51.26)},
        {title = 'Take wood to the supermarket', payment = 500, vehicles = {'daf', 'trailerlogs'}, start = {vector3(-566.59, 5353.52, 70.24), 344.31}, trailer = {vector3(-513.17, 5257.65, 80.74), 162.58}, arrive = vector3(103.57, -1819.37, 25.56)},
        {title = 'bring wood to the shop 1', payment = 500, vehicles = {'daf', 'trailerlogs'}, start = {vector3(-566.59, 5353.52, 70.24), 344.31}, trailer = {vector3(-513.17, 5257.65, 80.74), 162.58}, arrive = vector3(-1292.01, -807.06, 19)},
        {title = 'bring wood to the shop 2', payment = 500, vehicles = {'daf', 'trailerlogs'}, start = {vector3(-566.59, 5353.52, 70.24), 344.31}, trailer = {vector3(-513.17, 5257.65, 80.74), 162.58}, arrive = vector3(-384.46, 1220.5, 327)},
    },
}
...
Strings = {
    ...
    ['start_job'] = 'laal chandan delivery',
    ['truck'] = 'Truck',
    ['trailer'] = 'trailerlogs',
