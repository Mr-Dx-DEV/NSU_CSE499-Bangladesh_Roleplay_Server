...
CreateThread(function()
  exports['sjrp-target']:AddBoxZone("1234", vector3(458.95, -1016.99, 28.17), 1.5, 1.6, {
    name = "1234", 
    heading = 102.0, 
    debugPoly = false, 
    minZ = 25.7, 
...
RegisterNetEvent('qb-k9:client:menu', function()
  ...
  exports['sjrp-menu']:openMenu(K9Purchase)
end)
...
exports['sjrp-menu']:openMenu(K9Dawgs)
end)
...
RegisterCommand("caninecommanders", function()
  if activate_k9 then
    ...
    exports['sjrp-menu']:openMenu(k9Commands)
  end
end, false) 
