...
RegisterNetEvent('qb-bankrobbery:server:callCops', function(type, bank, streetLabel, coords)
    ...
    TriggerClientEvent("sjrp-phone:client:addPoliceAlert", -1, alertData)
end)
...
RegisterServerEvent('qb-bankrobbery:client:robberyCall')
AddEventHandler('qb-bankrobbery:server:callCops', function(type, safe, streetLabel, coords)
    local data = {displayCode = '10-90', description = 'Possible Bank Robbery', isImportant = 0, recipientList = {'police'}, length = '15000', infoM = 'fa-fas fa-dollar-sign-circle', info = 'There are some Goons in the Bank with Weapons'}
    ...
    local alertData = {
        title = "10-90 | Possible Bank Robbery",
        coords = {x = coords.x, y = coords.y, z = coords.z},
