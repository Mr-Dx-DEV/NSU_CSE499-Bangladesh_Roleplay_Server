...
RegisterServerEvent('qb-jewellery:server:PoliceAlertMessage')
AddEventHandler('qb-jewellery:server:getCops', function(type, safe, streetLabel, coords)
    local data = {displayCode = '10-90', description = 'Possible Jewelery Robbery', isImportant = 0, recipientList = {'police'}, length = '15000', infoM = 'fa-info-circle', info = 'Caller reports gunshots and loud explosions in the area'}
    ...
    local alertData = {
        title = "10-90 | Possible jelery Robbery",
        coords = {x = coords.x, y = coords.y, z = coords.z},
        description = "Suspect acticing suspicious at: "..streetLabel..")"
    }
    TriggerClientEvent("qb-jewelery:client:robberyCall", -1, type, safe, streetLabel, coords)
