Config = {}
Config.UsingTarget = false -- If you are using sjrp-target (uses entity zones to target vehicles)
...
Config.Shops = {
    ['pdm'] = {
        ...
        ['ShopLabel'] = 'Jonogon Car House', -- Blip name
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                ...
                defaultVehicle = 'warrener', -- Default display vehicle
                chosenVehicle = 'warrener', -- Same as default but is dynamically changed when swapping vehicles
            },
            [2] = {
            ...
            [4] = {
                ...
                defaultVehicle = 'surge',
                chosenVehicle = 'surge',
            },
            [5] = {
                coords = vector4(-928.53, -2036.68, 8.50, 258.4),
                defaultVehicle = 'habanero',
                chosenVehicle = 'habanero',
            },
            [6] = {
