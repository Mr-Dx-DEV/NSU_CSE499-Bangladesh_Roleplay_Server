...
local function ClearMenu()
	TriggerEvent("sjrp-menu:closeMenu")
end
        ...
        if OutsideVehicles[vehicle.plate] then
            ...
            QBCore.Functions.SpawnVehicle(vehicle.vehicle, function(veh)
                ...
                QBCore.Functions.TriggerCallback('qb-garage:server:GetVehicleProperties', function(properties)
                    ...
                    TaskEnterVehicle(PlayerPedId(), veh, -1, -1, 1.5, 1, 0)
                    exports['sjrp-fuel']:SetFuel(veh, vehicle.fuel)
...
RegisterNetEvent("qb-garages:client:HouseGarage", function(house)
    QBCore.Functions.TriggerCallback("qb-garage:server:GetHouseVehicles", function(result)
        if result == nil then
            ...
            exports['sjrp-menu']:openMenu(MenuHouseGarageOptions)
        end
    end, house)
end)
...
RegisterNetEvent("qb-garages:client:DepotList", function()
    QBCore.Functions.TriggerCallback("qb-garage:server:GetDepotVehicles", function(result)
        if result == nil then
            ...
            exports['sjrp-menu']:openMenu(MenuDepotOptions)
        end
    end)
end)
...
RegisterNetEvent("qb-garages:client:VehicleList", function()
    QBCore.Functions.TriggerCallback("qb-garage:server:GetUserVehicles", function(result)
        if result == nil then
            ...
            exports['sjrp-menu']:openMenu(MenuPublicGarageOptions)
        end
    end, currentGarage)
end)
...
RegisterNetEvent("qb-garages:client:GangVehicleList", function()
    QBCore.Functions.TriggerCallback("qb-garage:server:GetUserVehicles", function(result)
        if result == nil then
            ...
            exports['sjrp-menu']:openMenu(MenuGangGarageOptions)
        end
    end, currentGarage)
end)
...
RegisterNetEvent("qb-garages:client:JobVehicleList", function()
    QBCore.Functions.TriggerCallback("qb-garage:server:GetUserVehicles", function(result)
        if result == nil then
            ...
            exports['sjrp-menu']:openMenu(MenuJobGarageOptions)
        end
    end, currentGarage)
end)
                    ...
                    if IsControlJustPressed(0, 38) then
                        ...
                        QBCore.Functions.TriggerCallback('qb-garage:server:checkVehicleOwner', function(owned)
                            if owned then
                                ...
                                local totalFuel = exports['sjrp-fuel']:GetFuel(curVeh)
...
RegisterNetEvent('Change:number:client', function(plate)
    ...
    if IsPedInAnyVehicle(ped, false) then
        ...
        QBCore.Functions.Notify('You need to be in vehicle!', 'error')
    end
end)
