...
-- Dumping database structure for nsu_cse499
CREATE DATABASE IF NOT EXISTS `nsu_cse499` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci */;
USE `nsu_cse499`;

-- Dumping structure for table nsu_cse499.bank_accounts_new
...
-- Dumping data for table nsu_cse499.bank_accounts_new: ~25 rows (approximately)
...
-- Dumping structure for table nsu_cse499.bans
...
-- Dumping data for table nsu_cse499.bans: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.dealers
...
-- Dumping data for table nsu_cse499.dealers: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.lapraces
...
-- Dumping data for table nsu_cse499.lapraces: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.management_outfits
...
-- Dumping data for table nsu_cse499.management_outfits: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.occasion_vehicles
...
-- Dumping data for table nsu_cse499.occasion_vehicles: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.ox_doorlock
...
-- Dumping data for table nsu_cse499.ox_doorlock: ~6 rows (approximately)
...
-- Dumping structure for table nsu_cse499.ox_inventory
...
-- Dumping data for table nsu_cse499.ox_inventory: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.players
...
-- Dumping data for table nsu_cse499.players: ~1 rows (approximately)
...
-- Dumping structure for table nsu_cse499.playerskins
...
-- Dumping data for table nsu_cse499.playerskins: ~0 rows (approximately)
...
-- Dumping structure for table nsu_cse499.player_groups
...
-- Dumping data for table nsu_cse499.player_groups: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.player_jobs_activity
...
-- Dumping data for table nsu_cse499.player_jobs_activity: ~0 rows (approximately)
...
-- Dumping structure for table nsu_cse499.player_mails
...
-- Dumping data for table nsu_cse499.player_mails: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.player_outfits
...
-- Dumping data for table nsu_cse499.player_outfits: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.player_outfit_codes
...
-- Dumping data for table nsu_cse499.player_outfit_codes: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.player_transactions
...
-- Dumping data for table nsu_cse499.player_transactions: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.player_vehicles
...
-- Dumping data for table nsu_cse499.player_vehicles: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.properties
...
-- Dumping data for table nsu_cse499.properties: ~0 rows (approximately)
...
-- Dumping structure for table nsu_cse499.properties_decorations
...
-- Dumping data for table nsu_cse499.properties_decorations: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.users
...
-- Dumping data for table nsu_cse499.users: ~0 rows (approximately)
...
-- Dumping structure for table nsu_cse499.vehicle_financing
...
-- Dumping data for table nsu_cse499.vehicle_financing: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.weed_plants
...
-- Dumping data for table nsu_cse499.weed_plants: ~0 rows (approximately)

-- Dumping structure for table nsu_cse499.xt_prison
...
-- Dumping data for table nsu_cse499.xt_prison: ~0 rows (approximately)
INSERT INTO `xt_prison` (`identifier`, `jailtime`) VALUES
	('BI315886', 0);

-- Dumping structure for table nsu_cse499.xt_prison_items
...
-- Dumping data for table nsu_cse499.xt_prison_items: ~0 rows (approximately)
